...
export default function MoviesPage() {
    ...
    function filterSeries(series) {
        return series.filter((show) => {
            ...
            return (
                (genre === "all" || show.genre_ids.includes(parseInt(genre))) &&
                (language === "all" || show.original_language === language) &&
                (rating === "all" || show.vote_average >= parseFloat(rating)) &&
    ...
    const filteredSeries = useMemo(() => {
        ...
        return query
            ? filterSeries(seriesData.results, { genre, language, rating, yearRange })
            : seriesData.results;
    }, [seriesData, genre, language, rating, yearRange, query]);
